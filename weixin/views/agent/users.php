...
<div class="form">
    ...
    <div class="table-hr">
        <p style="background:white;"><span class="table_header">用户姓名</span><span class="table_header">手机号</span><span class="table_header">水量余额</span></p>
    </div>
    <div class="table_bd" style="padding:0 8px;">

        <p class="red_line"><span class="table_header">用户姓名</span><span class="table_header">手机号</span><span class="table_header">水量余额</span></p>
    </div>
...
<script>
    $(function(){
        ...
        for(var index=0;index<list.length;index++){
            var item=list[index];
            var tr=' <p class="table_tr '+(index%2==0?"blud_line":"red_line")+'"><span class="table_header">'+item.name+'</span><span class="table_header">'+item.tel+'</span><span class="table_header" style="color:'+getColorBywatervl(item.watervl)+'">'+item.watervl+'</span></p>';
            $(".table_bd").append($(tr));
        }
    });
