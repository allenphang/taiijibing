...
<div class="form">
    ...
    <div class="table-hr">
        <p style="background:white;"><span class="table_header">代理名称</span><span class="table_header">总用户数</span><span class="table_header">水袋销量总数</span></p>
    </div>
    <div class="table_bd" style="padding:0 8px;">

        <p class="red_line"><span class="table_header">代理名称</span><span class="table_header">总用户数</span><span class="table_header">水袋销量总数</span></p>
    </div>
...
<script>
    $(function(){
        ...
        for(var index=0;index<list.length;index++){
            var item=list[index];
            var tr=' <p class="table_tr '+(index%2==0?"blud_line":"red_line")+'"><span class="table_header">'+item.name+'</span><span class="table_header">'+item.totaluser+'</span><span class="table_header">'+item.totalwatersale+'</span></p>';
            $(".table_bd").append($(tr));
        }
    });
