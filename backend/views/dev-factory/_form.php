    ...
    <div class="col-sm-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <div class="hr-line-dashed"></div>
                <?= $form->field($model["model"], 'Type')->textInput(['maxlength' => 64]) ?>
                <div class="hr-line-dashed"></div>
                <?= $form->field($model["model"], 'CardFactory')->textInput(['maxlength' => 64]) ?>
                <div class="hr-line-dashed"></div>
                ...
                <div class="form-group field-adminroleuser-role_id required">
                    ...
                    <div class="fcontent">
                        <input id="address" type="text" class="baseinput" name="DevFactory[Address]">
                        ...
                        <span>经度：</span>
                        <input id="lng" type="text" class="baseinput" style="width: 80px" name="DevFactory[BaiDuLng]">
                        <span>纬度：</span>
                        <input id="lat" type="text" class="baseinput" style="width: 80px" name="DevFactory[BaiDuLat]">
                    </div>
                </div>
