...
return [
    ...
    'on beforeAction' => function($action)
    {
        ...
        if(yii::$app->user->isGuest &&
            !in_array(Yii::$app->controller->id.'/'.Yii::$app->controller->action->id, ['shop/index','shop/agent-list','shop/get-distance','shop/get-goods','site/login', 'user/request-password-reset', 'user/reset-password', 'site/captcha']) &&
